...
@JsonDeserialize(builder = StringListProperty.Builder.class)
public final class StringListProperty implements IBaseProperty {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof StringListProperty && equalTo((StringListProperty) other);
    }
    ...
    private boolean equalTo(StringListProperty other) {
    ...
    public interface KeyStage {
        ...
        Builder from(StringListProperty other);
    }

    public interface _FinalStage {
        StringListProperty build();
    ...
    public static final class Builder implements KeyStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(StringListProperty other) {
            key(other.getKey());
        ...
        @java.lang.Override
        public StringListProperty build() {
