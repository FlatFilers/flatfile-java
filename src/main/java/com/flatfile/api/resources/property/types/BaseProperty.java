...
public final class BaseProperty implements IBaseProperty {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof BaseProperty && equalTo((BaseProperty) other);
    }
    ...
    private boolean equalTo(BaseProperty other) {
    ...
    public static final class Builder implements KeyStage, _FinalStage {
        ...
        @Override
        public Builder from(BaseProperty other) {
            key(other.getKey());
