...
public final class BooleanProperty implements IBaseProperty {
    ...
    private final Optional<BooleanPropertyConfig> config;
    ...
    private BooleanProperty(
            ...
            Optional<BooleanPropertyConfig> config,
    ...
    @JsonProperty("config")
    public Optional<BooleanPropertyConfig> getConfig() {
        return config;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof BooleanProperty && equalTo((BooleanProperty) other);
    }
    ...
    private boolean equalTo(BooleanProperty other) {
    ...
    public interface _FinalStage {
        ...
        _FinalStage config(Optional<BooleanPropertyConfig> config);

        _FinalStage config(BooleanPropertyConfig config);
    }
    ...
    public static final class Builder implements KeyStage, _FinalStage {
        ...
        private Optional<BooleanPropertyConfig> config = Optional.empty();
        ...
        @Override
        public Builder from(BooleanProperty other) {
            key(other.getKey());
        ...
        public _FinalStage config(Optional<BooleanPropertyConfig> config) {
            this.config = config;
            return this;
        }
