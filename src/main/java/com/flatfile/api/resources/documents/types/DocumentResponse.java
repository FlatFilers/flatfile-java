...
public final class DocumentResponse {
    ...
    private DocumentResponse(Document data, Map<String, Object> additionalProperties) {
        this.data = data;
    ...
    public interface DataStage {
        _FinalStage data(@NotNull Document data);
    ...
    public static final class Builder implements DataStage, _FinalStage {
        ...
        @java.lang.Override
        @JsonSetter("data")
        public _FinalStage data(@NotNull Document data) {
        ...
        public DocumentResponse build() {
            return new DocumentResponse(data, additionalProperties);
        }
    }
}
