...
public final class ListDocumentsResponse {
    private final List<DocumentResponse> data;

    private final Map<String, Object> additionalProperties;

    private ListDocumentsResponse(List<DocumentResponse> data, Map<String, Object> additionalProperties) {
        this.data = data;
    ...
    public static final class Builder {
        private List<DocumentResponse> data = new ArrayList<>();
        ...
        public Builder data(List<DocumentResponse> data) {
            this.data.clear();
            this.data.addAll(data);
            return this;
        }

        public Builder addData(DocumentResponse data) {
            this.data.add(data);
            return this;
        }

        public Builder addAllData(List<DocumentResponse> data) {
            this.data.addAll(data);
            return this;
        }
