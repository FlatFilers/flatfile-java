...
@JsonDeserialize(builder = AiGenerateSampleDataJobConfig.Builder.class)
public final class AiGenerateSampleDataJobConfig {
    ...
    private AiGenerateSampleDataJobConfig(SpaceId spaceId, AppId appId, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof AiGenerateSampleDataJobConfig && equalTo((AiGenerateSampleDataJobConfig) other);
    }
    ...
    private boolean equalTo(AiGenerateSampleDataJobConfig other) {
    ...
    public interface SpaceIdStage {
        ...
        Builder from(AiGenerateSampleDataJobConfig other);
    }
    ...
    public interface _FinalStage {
        AiGenerateSampleDataJobConfig build();
    }
    ...
    public static final class Builder implements SpaceIdStage, AppIdStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(AiGenerateSampleDataJobConfig other) {
        ...
        @java.lang.Override
        public AiGenerateSampleDataJobConfig build() {
            return new AiGenerateSampleDataJobConfig(spaceId, appId, additionalProperties);
        }
    }
}
