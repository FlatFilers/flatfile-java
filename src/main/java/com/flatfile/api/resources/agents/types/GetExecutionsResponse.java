...
public final class GetExecutionsResponse {
    ...
    private GetExecutionsResponse(
            Optional<Pagination> pagination, List<Execution> data, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GetExecutionsResponse && equalTo((GetExecutionsResponse) other);
    }
    ...
    private boolean equalTo(GetExecutionsResponse other) {
    ...
    public static final class Builder {
        ...
        private List<Execution> data = new ArrayList<>();
        ...
        public Builder from(GetExecutionsResponse other) {
        ...
        public Builder data(List<Execution> data) {
            this.data.clear();
            this.data.addAll(data);
            return this;
        }

        public Builder addData(Execution data) {
            this.data.add(data);
            return this;
        }

        public Builder addAllData(List<Execution> data) {
            this.data.addAll(data);
            return this;
        }

        public GetExecutionsResponse build() {
            return new GetExecutionsResponse(pagination, data, additionalProperties);
        }
    }
}
