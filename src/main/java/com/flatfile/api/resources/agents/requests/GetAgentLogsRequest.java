...
@JsonDeserialize(builder = GetAgentLogsRequest.Builder.class)
public final class GetAgentLogsRequest {
    private final EnvironmentId environmentId;

    private final Map<String, Object> additionalProperties;

    private GetAgentLogsRequest(EnvironmentId environmentId, Map<String, Object> additionalProperties) {
    ...
    private boolean equalTo(GetAgentLogsRequest other) {
    ...
    public interface EnvironmentIdStage {
        ...
        Builder from(GetAgentLogsRequest other);
    }

    public interface _FinalStage {
        GetAgentLogsRequest build();
    }
