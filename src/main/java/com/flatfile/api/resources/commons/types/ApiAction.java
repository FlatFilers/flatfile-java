...
@JsonDeserialize(builder = ApiAction.Builder.class)
public final class ApiAction implements IAction {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ApiAction && equalTo((ApiAction) other);
    }
    ...
    private boolean equalTo(ApiAction other) {
    ...
    public interface LabelStage {
        IdStage label(@NotNull String label);

        Builder from(ApiAction other);
    }

    public interface IdStage {
        TargetIdStage id(@NotNull ActionId id);
    }

    public interface TargetIdStage {
        UpdatedAtStage targetId(@NotNull String targetId);
    }
    ...
    public static final class Builder
            implements LabelStage, IdStage, TargetIdStage, UpdatedAtStage, CreatedAtStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ApiAction other) {
        ...
        @java.lang.Override
        @JsonSetter("label")
        public IdStage label(@NotNull String label) {
        ...
        @java.lang.Override
        @JsonSetter("id")
        public TargetIdStage id(@NotNull ActionId id) {
        ...
        @java.lang.Override
        @JsonSetter("targetId")
        public UpdatedAtStage targetId(@NotNull String targetId) {
