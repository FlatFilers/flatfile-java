...
@JsonDeserialize(builder = ActionWithoutLabel.Builder.class)
public final class ActionWithoutLabel implements IActionWithoutLabel {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ActionWithoutLabel && equalTo((ActionWithoutLabel) other);
    }
    ...
    private boolean equalTo(ActionWithoutLabel other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ActionWithoutLabel other) {
            slug(other.getSlug());
        ...
        public ActionWithoutLabel build() {
            return new ActionWithoutLabel(
                    slug,
                    operation,
                    mode,
                    tooltip,
