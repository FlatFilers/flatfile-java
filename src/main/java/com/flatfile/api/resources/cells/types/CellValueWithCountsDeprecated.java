...
import com.flatfile.api.resources.records.types.ICellValue;
import com.flatfile.api.resources.records.types.RecordCounts;
import com.flatfile.api.resources.records.types.ValidationMessage;
...
@JsonDeserialize(builder = CellValueWithCountsDeprecated.Builder.class)
public final class CellValueWithCountsDeprecated implements ICellValue {
    ...
    private CellValueWithCountsDeprecated(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CellValueWithCountsDeprecated && equalTo((CellValueWithCountsDeprecated) other);
    }
    ...
    private boolean equalTo(CellValueWithCountsDeprecated other) {
    ...
    public static final class Builder {
        ...
        public Builder from(CellValueWithCountsDeprecated other) {
        ...
        public Builder counts(Optional<RecordCounts> counts) {
            this.counts = counts;
            return this;
        }

        public Builder counts(RecordCounts counts) {
            this.counts = Optional.of(counts);
            return this;
        }

        public CellValueWithCountsDeprecated build() {
            return new CellValueWithCountsDeprecated(
                    valid, messages, value, layer, updatedAt, counts, additionalProperties);
        }
    }
}
