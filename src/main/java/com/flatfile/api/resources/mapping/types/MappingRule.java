...
public final class MappingRule implements IMappingRuleConfig {
    ...
    /**
     * @return User ID of the user who suggested the mapping rule
     */
    ...
    public interface IdStage {
        CreatedAtStage id(@NotNull MappingId id);
    }
    ...
    public static final class Builder
        ...
        @java.lang.Override
        @JsonSetter("id")
        public CreatedAtStage id(@NotNull MappingId id) {
        ...
        /**
         * <p>User ID of the user who suggested the mapping rule</p>
         * @return Reference to {@code this} so that method calls can be chained together.
         */
        @java.lang.Override
